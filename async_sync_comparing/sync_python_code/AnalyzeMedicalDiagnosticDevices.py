...
class AnalyzeMedicalDiagnosticDevices:
    ...
    def dataframes_to_excel(self, dataframes: list = [pd.DataFrame], filenames: list = [str], index: int = 0) -> None:
        ...
        self.__data.create_file_with_some_sheets(dataframes, filenames, index)            
